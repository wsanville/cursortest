...
public class SQLiteCursorLoader extends AbstractCursorLoader {
  ...
  {
      new TransactionTask(this).execute(db, runnable);
  }
  ...
  private class ExecSQLTask extends
    ...
    private class TransactionTask extends ContentChangingTask<Object, Void, Void>
    {
        TransactionTask(SQLiteCursorLoader loader)
        {
            super(loader);
        }
        ...
        {
            SQLiteOpenHelper db = (SQLiteOpenHelper)params[0];
            TransactionRunnable runnable = (TransactionRunnable)params[1];
